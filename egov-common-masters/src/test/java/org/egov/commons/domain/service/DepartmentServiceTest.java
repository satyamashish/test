...
public class DepartmentServiceTest {
    ...
    public void test_should_create_department() {
        departmentService.createDepartment(getDepartmentModel());
        verify(departmentRepository).create(getDepartmentModel());
    }
    ...
    public void test_should_update_department() {
        departmentService.updateDepartment(getDepartmentModelForUpdate());
        verify(departmentRepository).update(getDepartmentModelForUpdate());
    }
