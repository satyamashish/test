...
public class DepartmentRowMapper implements RowMapper<Department> {
	...
	public Department mapRow(ResultSet rs, int rowNum) throws SQLException {
		...
		department.setCreatedBy(rs.getLong("createdBy"));
		department.setCreatedDate(rs.getDate("createdDate"));
		department.setLastModifiedBy(rs.getLong("lastModifiedBy"));
		department.setLastModifiedDate(rs.getDate("lastModifiedDate"));*/
