...
public class DepartmentRepository {
	...
	public void create(Department department) {
		Object[] obj=new Object[]{generateSequence("seq_eg_department"),department.getName(),department.getCode()
				,department.getActive(),department.getTenantId(),department.getCreatedBy()
				,new Date(new java.util.Date().getTime()),
				department.getLastModifiedBy(),new Date(new java.util.Date().getTime())};
	...
	public void update(Department department) {
		Object[] obj=new Object[]{department.getName(),department.getActive(),department.getLastModifiedBy()
